...
export default function Footer(){
    return(
        ...
        <>
        <div className="w-[1440px] h-[181px] px-[89px] flex-col justify-start items-center gap-8 inline-flex">
    <div className="w-screen h-px bg-gray-300"></div>
    <div className="self-stretch h-[92px] flex-col justify-center items-start gap-3 flex">
